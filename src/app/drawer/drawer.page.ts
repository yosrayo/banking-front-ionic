...
export class DrawerPage implements AfterViewInit {
  ...
  appPages: DrawerScreen[] = [
    ...
    { name: 'Recharge telephonique', icon: 'phone', url: '/menu/feedback' },
    { name: 'Transfert argent', icon: 'money', url: '/menu/invite-friend' },
    { name: 'Paiment marchand', icon: '', url: '/menu/invite-friend' },
    { name: 'Paiment facture', icon: 'group', url: '/paiment' },
    { name: 'Scanner et payer', icon: '', url: '/transaction' },
